...
export default function Page() {
    ...
    useEffect(() => {
        const manager = managers.find(item => item.value === parseInt(selectedManager));
        console.log(manager)
    ...
    const handleSubmit = async(e) => {
        ...
        const data = {
         ...
         await FetchApi({url: '/outlet/api/create-outlet', method: 'post', body: data, isToast: true})
    };
            ...
            <section className="mt-10 flex justify-between items-center">
                <div className="flex flex-col space-y-2">
                    <div className="flex justify-start items-center">
                        ...
                        <h1 className="text-lg md:text-5xl font-semibold ml-5">Add Outlet</h1>
                    </div>
                </div>
                <button type="submit" className="text-sm text-white bg-black rounded-md px-3 py-2">
                    Add Outlet
                </button>
            </section>
