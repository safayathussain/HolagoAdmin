        ...
        <div className="flex flex-col bg-white overflow-hidden px-3 w-full">
          ...
          <ul className="flex flex-col ">
            <li>
              <Link
                href="/dashboard"
                className={`flex flex-row items-center duration-300 text-black ${
                  pathname == "/dashboard" ? "bg-black !text-white" : ""
                } hover:bg-black rounded-xl my-1 py-0 group !no-underline`}
              >
                <span className="inline-flex items-center justify-center px-2 py-2 text-lg">
                  <svg
                    ...
                    className={`${
                      pathname == "/dashboard"
                        ? "hidden"
                        : "group-hover:hidden duration-300"
                    }`}
                  >
                    <circle
                      cx="16.75"
            ...
            <li>
              <button
                ...
                className={`flex flex-row items-center duration-300 text-black hover:bg-black rounded-xl my-1 py-0 group !no-underline w-full`}
              >
                <span className="inline-flex items-center justify-center px-2 py-2 text-lg group">
                  <svg
                    width="24"
